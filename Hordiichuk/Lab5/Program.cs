...
// Простір імен для всього проєкту
namespace ConsoleApplication8
{
    ...
    class Triangle : Figure
    {
        ...
        {
            // Перевірка на коректність значень а, b, с
        ...
        // 3. Реалізація методів доступу до прихованих полів а, b, с
        // 3.1. Встановлення значень полів а, b, с
    ...
    /**
     * 3. Похідний клас "Кольоровий трикутник"
     */
    ...
    class TriangleColor : Triangle
    {
        ...
        public TriangleColor(string name, double a, double b, double c, int color) :
            base(name, a, b, c) // Виклик конструктора базового класу (Triangle)
        {
        ...
        public override double Area2
        {
            get
            {
                ...
                // 2. Викликати властивість базового класу (Triangle)
                return base.Area2;
            }
        }

        // 5. Метод Area() викликає однойменний метод базового класу
        public override double Area()
        {
            // 1. Вивести контрольне повідомлення
            Console.WriteLine("Method TriangleColor.Area():");
            // 2. Викликати метод базового класу (Triangle)
            return base.Area();
        }
        ...
        public override void Print()
        {
            base.Print(); // Виклик методу базового класу (Triangle)
            Console.WriteLine("color = {0}", color);
        }
    }

    /**
     * 4. Головний клас програми з точкою входу Main
     */
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // 2. Оголосити екземпляри класів Triangle, TriangleColor
            ...
            Console.WriteLine("--- Демонстрація методу Print() ---");
            refFg = Tr;
            refFg.Print();

            Console.WriteLine(); // Розділювач

            refFg = TrCol;
            refFg.Print();

            // 4. Демонстрація поліморфізму на прикладі методу Area()
            Console.WriteLine("\n--- Демонстрація методу Area() ---");
            refFg = Tr;
            ...
            Console.WriteLine("\n--- Демонстрація властивості Area2 ---");
            refFg = Tr;
