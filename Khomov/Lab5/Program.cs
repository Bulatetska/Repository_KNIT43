...
class Triangle : Figure
{
    ...
    // 5. Реалізація методу Area(), який в класі Figure оголошений як абстрактний
    public override double Area()
    {
        ...
        // 2. Вивести результат - для контролю
    ...
    // 6. Перевизначення віртуального методу Print
...
class Program
{
    static void Main(string[] args)
    {
        ...
        TriangleColor TrCol = new TriangleColor("TriangleColor", 1, 3, 3, "Green");
