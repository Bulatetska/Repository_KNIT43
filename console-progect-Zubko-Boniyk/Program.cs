/* 2048 — гра-головоломка з розсувним номером. 

Пересувайте всі плитки на дошці в одному напрямку: вгору, вниз, ліворуч або праворуч. 

Якщо два подібні числа зіштовхуються, вони об'єднаються в плитку вищого значення. 

Мета полягає в тому, щоб отримати «2048» цінну плитку на дошці, але можна навіть продовжувати грати після цього, щоб спробувати отримати високий рахунок.
*/
