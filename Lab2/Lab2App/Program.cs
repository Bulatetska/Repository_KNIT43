...
// Вправа 3
// 3. Задати послідовність дійсних чисел a1, a2, …, an. Визначити в цій послідовності кількість сусідств: 1) двох додатних чисел; 2) двох нульових елементів. Вивести на екран відповідні повідомлення. 
        Console.WriteLine("****** Вправа 3 ******");
        double[] seq = { 2, 3, -4, 1, 0, 0, 5, 0 };
